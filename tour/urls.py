...
#  path('updatedestination/<slug:destination_slug>', UpdateDestination.as_view(), name='update_destination'),
    path('destination/<str:destination_name>/', OneDestination.as_view(), name='one_destination'),
    ...
    path('activities/<str:region_name>/', Tourlist.as_view(), name='tour_list'),
    # gauley bhai
    path('tourdetails/<str:tour_name>/', TourDeatails.as_view(), name='tour_details'),
